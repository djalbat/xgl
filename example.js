        ...
        _createClass(Pan2, [
          ...
          },
          {
            ...
            value: function fromInitialPositionMouseWheelDeltaMultiplierAndRelativeMouseCoordinatesMultiplier(initialPosition, mouseWheelDeltaMultiplier, relativeMouseCoordinatesMultiplier) {
              var offsets = (0, _vector).scale3(initialPosition, _constants.INVERT_MULTIPLIER), pan = new Pan2(offsets, mouseWheelDeltaMultiplier, relativeMouseCoordinatesMultiplier);
              return pan;
            }
          }
        ]);
