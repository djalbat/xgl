  ...
  var require_vector = __commonJS({
    "lib/maths/vector.js"(exports) {
      ...
      function total2() {
        ...
        var zero = zero2(), total = vectors.reduce(function(total5, vector) {
          total5 = add2(total5, vector);
          return total5;
        }, zero);
        return total;
      }
      function total3() {
        ...
        var zero = zero3(), total = vectors.reduce(function(total5, vector) {
          total5 = add3(total5, vector);
          return total5;
        }, zero);
        return total;
      }
      function total4() {
        ...
        var zero = zero4(), total = vectors.reduce(function(total5, vector) {
          total5 = add4(total5, vector);
          return total5;
        }, zero);
        return total;
      }
