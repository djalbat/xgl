...
This example makes use of the image map provided by the small Express application, made available at http://localhost:8000/imageMap. If you inspect the example HTML, you will also see that the JSON describing the image map has been embedded within it:
